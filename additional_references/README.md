...
Eight worked adapter examples that wrap third-party matching engines (six
C++, one Rust, one Go) behind `api/matching_engine_api.h`. Their purpose is
...
under `scripts/build_baselines.sh`. The eight adapters here are
