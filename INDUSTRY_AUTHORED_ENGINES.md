...
No number or finding here ranks or judges an author's engineering quality — the harness merely reports what each pinned commit does. Affiliations are as the authors publicly state them, not independently verified.
